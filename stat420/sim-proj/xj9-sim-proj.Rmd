...
We will use the sample data found in [`study_1.csv`](study_1.csv) with size of 15, three possible levels of noise and some values for $x_{i}$. 

- n = 15
- $\sigma \in (1, 5, 10)$
- $\hat{\text{E}}[Y \mid x_1 = -3, x_2 = 2.5, x_3 = 0.5, x_4 = 0]$

For each value of $\sigma$, we use 3000 simulations, thus total $3 ?? 3000 = 9000$ estimates.

To start, we initialize the seed and allocate memory for the estimates
