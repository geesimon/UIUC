...
#### Simulation
We now perform the simulation `r num_sims` times for each $\sigma$. Each time, we update the y variable in the data frame, leaving the x variables the same. We then fit a model, and store $\hat{\beta}_1$, $s_e^2$ and compute $\hat{\text{E}}[Y]$.
