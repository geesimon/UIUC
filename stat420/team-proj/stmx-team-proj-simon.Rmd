...
model = lm(as.formula(build_formula("SalePrice", names(SignificantPredictors))), 
                      data = house_data)

#model = lm(as.formula(build_formula("SalePrice", names(vif(model)[vif(model) < 5]))), data = house_data)
