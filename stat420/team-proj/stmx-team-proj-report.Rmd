...
for(name in colnames(test_data)) {
  if(name %in% CategoricalPredictors) {
    test_data[[name]] = factor(test_data[[name]])
  }
}
...
#Replace new categorical value with existing one in training dataset
test_data$MSSubClass[test_data$MSSubClass==150] = 120
