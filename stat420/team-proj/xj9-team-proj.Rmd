...
The covariance test shows `OverallQual`, `TotalBsmtSF`, `YearBuilt`, `YearRemodAdd`, `ExterQual`, `0.61358`, `FullBath`, `Fireplaces`, `0.640409` has high relation with `SalePrice`.
