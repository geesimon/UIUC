...
- Me/Xiaoming Ji (xj9)
    - Which parts of the project were worked on by that member
        - Almost every part. Specifically, nominated the project topic, completed project proposal and submission, come out with systematic data pre-processing approach, a systematic way to select predictors, find a way to optimize model for loocv rmse, test against kaggle score, made discussions and appendix, and prepared the final report for team review, and report submission.
    ...
    - Proportion of the project completed by that member (**Score: 67%**)
        - Yes, its a little unbalanced work and commitment among us.
...
- Tesa Ho (tnho2)
    ...
    - Proportion of the project completed by that member (**Score: 30%**)
        -  Completed introduction, correlation scatterplots and histograms for data analysis, model prediction and evaluation.
